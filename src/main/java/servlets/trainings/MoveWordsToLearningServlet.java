...
import messageSystem.messages.trainings.toService.MessageToMoveWordsToLearning;
...
public class MoveWordsToLearningServlet extends HttpServlet implements NonAbonentServlet {
    ...
    public void createMessage() {
        MessageSystem.INSTANCE.sendMessageForService(new MessageToMoveWordsToLearning(null, AddressService.INSTANCE.getTrainingServiceAddress(),
